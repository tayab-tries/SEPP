...
from client.modules.dashboard.dashboard_shell import DashboardCard
from client.modules.dashboard.settings.settings_comms import CommunicationPermissionsCard
from client.modules.dashboard.settings.settings_right_panel import (
    LockdownRulesCard,
    SecurityAdvisoryCard,
)
from client.modules.dashboard.settings.settings_sliders import AIMonitoringCard
