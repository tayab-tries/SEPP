...
class TopBarWidget(QFrame):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.sync_status_label.setStyleSheet(f"font-size: 13px; font-weight: 600; color: {TEXT_SECONDARY}; padding: 0 12px;")
        ...
        self.complete_grading_button = QPushButton("Sync / Save Grades")
        self.complete_grading_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.complete_grading_button.setFixedHeight(38)
        self.complete_grading_button.setStyleSheet(f"""
            QPushButton {{
                background: #10b981;
                color: white;
                border: none;
        ...
        """)
        root.addWidget(self.complete_grading_button)
