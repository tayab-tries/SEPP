...
class QuestionAreaWidget(QWidget):
    ...
    def __init__(self, questions: list[dict], answers: list[dict] | None = None, parent=None) -> None:
        ...
        for question in self.questions:
            ...
            if q_type == "mcq":
                widget = MCQQuestionWidget(question, answer=answer)
            else:
                widget = EssayQuestionWidget(question, answer=answer)
